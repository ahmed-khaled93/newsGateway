...
<div class="row">
		<article class="col-md-12 article-list">
			<div class="inner">
				...
				<div class="details">
					...
					<h1>
						<a href="single.html">Donec consequat arcu at ultrices sodales quam erat aliquet diam</a>
					</h1>
		...
		<article class="col-md-12 article-list">
			<div class="inner">
				...
				<figure>
					<a href="single.html">
						<img src="/frontend/images/news/img02.jpg" alt="Sample Article">
					</a>
				</figure>
				...
				<div class="details">
					...
					<h1>
						<a href="single.html">Maecenas accumsan tortor ut velit pharetra mollis</a>
					</h1>
		...
		<article class="col-md-12 article-list">
			<div class="inner">
				...
				<figure>
					<a href="single.html">
						<img src="/frontend/images/news/img03.jpg" alt="Sample Article">
					</a>
				</figure>
				...
				<div class="details">
					...
					<h1>
						<a href="single.html">Nulla facilisis odio quis gravida vestibulum Proin venenatis pellentesque arcu</a>
					</h1>
		...
		<article class="col-md-12 article-list">
			<div class="inner">
				...
				<figure>
					<a href="single.html">
						<img src="/frontend/images/news/img09.jpg" alt="Sample Article">
					</a>
				</figure>
				...
				<div class="details">
					...
					<h1>
						<a href="single.html">Maecenas blandit ultricies lorem id tempor enim pulvinar at</a>
					</h1>
